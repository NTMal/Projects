...
#Plot 2 Calculate the average number of vehicles sold by vehicle type and show as bar chart     
        # use groupby to create relevant data for plotting
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            ...
            html.Div(className='chart-row', children=[
                html.Div(children=R_chart1, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'}),
                html.Div(children=R_chart2, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'})
            ], style={'width': '100%', 'display': 'flex'}),
    
            # Second row: Charts 3 and 4
            html.Div(className='chart-row', children=[
                html.Div(children=R_chart3, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'}),
                html.Div(children=R_chart4, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'})
            ], style={'width': '100%', 'display': 'flex'})
        ]
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    # Check for Yearly Statistics.                             
        ...
        exp_data=yearly_data.groupby('Vehicle_Type')['Advertising_Expenditure'].sum().reset_index() # type: ignore
        ...
        return [
            # First row: Charts 1 and 2
            html.Div(className='chart-row', children=[
            html.Div(children=Y_chart1, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'}),
            html.Div(children=Y_chart2, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'})
            ], style={'width': '100%', 'display': 'flex'}),
            # Second row: Charts 3 and 4
            html.Div(className='chart-row', children=[
            html.Div(children=Y_chart3, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'}),
            html.Div(children=Y_chart4, style={'width': '50%', 'display': 'inline-block', 'padding': '10px'})
            ], style={'width': '100%', 'display': 'flex'})
        ]
    else:
        return None
